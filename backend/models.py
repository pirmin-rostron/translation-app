...
class TranslationJob(Base):
    ...
    formality = Column(String(20), nullable=False, default="neutral")
    review_mode = Column(String(20), nullable=False, default="autopilot")
    preserve_formatting = Column(Boolean, nullable=False, default=True)
    glossary_enabled = Column(Boolean, nullable=False, default=True)
    ...
    estimated_api_cost_usd = Column(Float, nullable=True)
    due_date = Column(Date, nullable=True)
    tokens_last_updated = Column(DateTime, nullable=True)
