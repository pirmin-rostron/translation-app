...
from routers import auth, dashboard, documents, glossary_suggestions, glossary_terms, projects, stats, translation_jobs, waitlist
...
app.include_router(glossary_suggestions.router)
